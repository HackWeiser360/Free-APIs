...
This API list is not a marketing tool, but a tool to help the
community build applications and use free, public APIs quickly and easily. 

For information on contributing to this project, please see the [contributing guide](.github/CONTRIBUTING.md).

For more information about author and how to connect to him visit [here](.github/ConnectAuthor.md)
...
| [Picatic](http://developer.picatic.com/?utm_medium=web&utm_source=github&utm_campaign=Free-APIs%20repo&utm_content=toddmotto) | Sell tickets anywhere | `apiKey` | Yes | Unknown |
